"""
Django settings for Tracing_tool project.
...
SECRET_KEY = 'django-insecure-&2ee6od48rpi4=)7+zwx9l)44_1$x42@q%13=s8q3+_1#rjzm('
...
ROOT_URLCONF = 'Tracing_tool.urls'
...
WSGI_APPLICATION = 'Tracing_tool.wsgi.application'
